        ...
        <div id="sidebar-menu">
            <ul id="side-menu">
                ...
                @canany(['purchases.view', 'purchases.create', 'purchase.create.multiple', 'purchases.import'])
                    <li class="{{ request()->routeIs('allpurchases', 'purchase.create', 'purchase.create.multiple', 'purchase.edit', 'purchase-detail', 'purchase.importform') ? 'menuitem-open' : '' }}">
                        ...
                        <div class="collapse {{ request()->routeIs(['allpurchases', 'purchase.create', 'purchase.create.multiple', 'purchase.edit', 'purchase-detail', 'purchase.importform']) ? 'show' : '' }}"
                            id="stocksMenu">
                            <ul class="nav-second-level">
                                @can('purchases.view')
                                    <li><a href="{{ route('allpurchases') }}" class="{{ request()->routeIs('allpurchases') ? 'active' : '' }}">All
                                Stocks</a></li> @endcan
                                @can('purchases.import')
                                    <li><a href="{{ route('purchase.importform') }}"
                                class="{{ request()->routeIs('purchase.importform') ? 'active' : '' }}">Import Stocks</a></li> @endcan
                            </ul>
                        </div>
                    </li>
                @endcanany
                ...
                @can(['parties.view', 'transactions.view'])
                    <li>
                        <a data-toggle="collapse" href="#partyMenu" role="button" aria-expanded="false"
                            aria-controls="partyMenu">
                            <i class="mdi mdi-account-cash-outline"></i>
                            <span>Party</span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="partyMenu">
                            <ul class="nav-second-level">
                                <li><a href="{{ route('parties.listparties') }}">Party List</a></li>
