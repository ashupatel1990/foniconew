    ...
    <div class="container-fluid">
        ...
        <div class="logo-box">
            <a href="{{ route('dashboard')}}" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <img src="{{asset('assets/images/new_logo/fonico_mobiles.jpg')}}" alt="FONICO Mobile" height="40">
                </span>
                <span class="logo-lg">
                    <img src="{{asset('assets/images/new_logo/fonico_mobiles.jpg')}}" alt="FONICO Mobile" height="20">
                </span>
            </a>

            <a href="{{ route('dashboard')}}" class="logo logo-light text-center">
                <span class="logo-sm">
                    <img src="{{ asset('assets/images/new_logo/fonico_mobiles.jpg') }}" alt="FONICO Mobile" height="22">
                </span>
                <span class="logo-lg">
                    <img src="{{asset('assets/images/new_logo/fonico_mobiles.jpg')}}" alt="FONICO Mobile" height="40">
                </span>
