                    ...
                    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" name="profile_image" class="form-control-file" id="avatarInput" accept=".jpg,.jpeg,.png,image/jpeg,image/png">
                ...
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex' },
                    {
                        ...
                        render: function (data) {
                            return `<img src="public/admin/users/${data}" alt="Avatar" class="rounded-circle" width="40" height="40">`;
                        }
                    },
                    { data: 'name', name: 'name' },
