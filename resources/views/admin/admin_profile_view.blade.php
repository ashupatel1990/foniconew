        ...
        <div class="col-lg-4 col-xl-4">
            <div class="card-box text-center">
                @if($admin->profile_image)
                    <img src="{{asset('admin/users/'. $admin->profile_image )}}" class="rounded-circle avatar-lg img-thumbnail" alt="{{$admin->name}}">
                @else
                    <img src="{{asset('admin/users/'. $admin->profile_image )}}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                @endif
