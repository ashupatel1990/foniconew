            ...
            <div class="content">
                <div class="badge">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path
                            d="M10.29 3.86 1.82 18.14A2 2 0 0 0 3.54 21h16.92a2 2 0 0 0 1.72-2.86L13.71 3.86a2 2 0 0 0-3.42 0z"
                ...
                <p class="lead">Please contact your administrator to request access. If you believe this is a mistake,
                    try returning to the dashboard or signing in with the correct account.</p>

                <div class="hint">
                    Pro tip: share this code with your admin <span class="code">ERR-403</span> so they can quickly grant
                ...
                <div class="actions">
                    <a class="btn" href="{{ url('/') }}">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                            aria-hidden="true">
                            <path d="M3 12l9-9 9 9" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <a class="btn secondary"
                        href="mailto:ashish.undhad26@gmail.com?subject=Access%20Request%20(403)&body=Hello%2C%0D%0A%0DI%20encountered%20a%20403%20(Access%20Denied)%20error%20on%20the%20application.%20Could%20you%20please%20grant%20me%20the%20required%20permissions%3F%0D%0A%0D%0AThanks.">
