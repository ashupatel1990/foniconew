...
<head>
    ...
    <meta charset="utf-8" />
    <title>@yield('title') - FONICO Mobile</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="● Buy-Sell ● Fonico Mobile One Stop solution for old phones" name="description" />
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            Created by
                            <a href="https://www.ascentwebservices.com" target="_blank" style="text-decoration:none; color:inherit;">
                                AscentWebServices
                            </a>
                        </div>
                    </div>
