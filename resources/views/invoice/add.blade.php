                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('create-invoice') }}" method="post"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold" for="customer_no">Contact No <span
                                ...
                                <div class="col-md-2">
                                    <label class="form-label fw-semibold">Payment Mode <span
                                    ...
                                    <div class="bg-light p-3 rounded shadow-sm">
                                        <ul class="mb-0 list-unstyled small">
                                            <li><b>Total Amount:</b> ₹ <span
                                                    id="totalAmountDisplay">{{ old('total_amount', 0) }}</span></li>
                                            <li><b>Discount:</b> ₹ <span
                                                    id="discountAmount">{{ old('discount_amount', 0) }}</span></li>
                                            ...
                                            <li class="mt-1 border-top pt-1"><b>Net Amount:</b> ₹
                                                <span id="netAmountDisplay"
                                                    class="fw-bold text-success">{{ old('net_amount', 0) }}</span>
                                            </li>
                                        </ul>
                    ...
                    <div class="item-row border rounded p-2 mb-2 shadow-sm bg-light" data-index="${itemCounter}" style="font-size: 14px;">
                        <div class="row g-2 align-items-end">
                            <div class="col-md-4">
                                ...
                                <div id="" class="list-group imei_suggestions"></div>
...
// console.log(data.length);
                    suggestions.innerHTML = ""; // clear old list
                    $row.find('.imei-error').hide();

                    // If no result
                    // if (!data || data.length === 0) {
                    //     $row.find('.imei-error').text('No IMEI found').show();
                    //     return;
                    // }

                    // Loop and create dropdown options
                    // if (data.count > 0) {
                        data.forEach(item => {
                            ...
                            option.addEventListener("click", function (e) {
                                ...
                                let length = imei.value.length;
                                imei.focus();
                                imei.setSelectionRange(length, length);
                            });
