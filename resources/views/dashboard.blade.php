        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"><span id="greeting" style="color: #1abc9c;"></span> {{ Auth()->user()->name }}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                                ...
                                <tbody>
                                    @foreach($todaysSales as $key => $sale)
                                        <tr>
                                            <td>
                                                <a href="{{route('saledetail', $sale->id)}}"><b>#{{ ($todaysSales->currentPage() - 1) * $todaysSales->perPage() + $key + 1 }}</b></a>
                                            </td>
                                            <td>
