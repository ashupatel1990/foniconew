jQuery(document).ready(function () {
    ...
    jQuery("#salemodelimei").on("blur", function (e) {
        ...
        if (modelID) {
            jQuery.ajax({
                url: "/admin_vm/fetchstockdata/" + modelID,
                type: "GET",
    ...
    jQuery("#model_imei").on("blur", function (e) {
        ...
        if (modelIMEI) {
            jQuery.ajax({
                url: "/admin_vm/fetchstockonimei/" + modelIMEI,
                type: "GET",
                success: function (data) {
...
// Auto complete partyname when add new stock
document.addEventListener("DOMContentLoaded", function () {
    ...
    partyInput.addEventListener("keyup", function () {
        ...
        if (query.length >= 2) {
            fetch(`/admin/purchase/getparties/?partname=${query}`)
